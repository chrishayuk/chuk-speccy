...
| [09 — SDK Capabilities from Classic Games](./09-sdk-capabilities-from-classic-games.md) | Works backwards from real titles (Manic Miner, Dizzy, Gauntlet, Renegade, Chaos, Daley Thompson's, Chase HQ/OutRun, …) to the **SDK capability backlog** — sprites · tilemaps/rooms · physics · SFX · scene-flow · actors/AI · inventory · scrolling · pseudo-3D · asset baking — each placed on the dial (host now / `cell80`-gated pure) with its agentability dividend. Companion to 08 / roadmap **E**. |
